...
function max2Numbers(arr) {
    // câu lệnh dưới dùng để xóa các phần tử trùng nhau:
    // nếu index khác indexOf thì nó sẽ k phải là phần tử đầu tiên có giá trị của nó và nó sẽ k đc add vào chuỗi mới
